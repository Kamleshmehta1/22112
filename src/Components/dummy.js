...
import { loginMethod, editMethod, searchMethod, blogTypeMethod } from "../createSlice";
    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: "none", md: "flex" } }}>
            ...
            {loginState ? (
              <>
                ...
                <Button sx={{ my: 2, color: "white", display: "block" }}>
                  <Link className="navLinks" to="/addBlogs" onClick={handleReset}>
                    Add Feed
                  </Link>
                </Button>
              </>
          ...
          {
            location.pathname === "/feed" && <Search sx={{ marginRight: "100px" }}>
              <SearchIconWrapper>
                <SearchIcon />
              </SearchIconWrapper>
              <StyledInputBase
